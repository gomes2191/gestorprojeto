            ...
            <fieldset>
                ...
                <div class="row form-hidden" style="display: none;">
                    ...
                    <div class="form-group col-xs-12 col-sm-12 col-md-12">
                        ...
                        <textarea id="provider_obs" class="form-control" name="provider_obs" style="margin-top: 0px; width: 100%; max-width: 100%;  margin-bottom: 0px; height: 150px; text-align: justify;" rows="3" placeholder="Outras informações..."><?= htmlentities(chk_array($modelo->form_data, 'providers_obs')); ?></textarea>
                    </div>
    ...
    function typeAction(objAction) {
        ...
        if (objAction.type === 'loadInfo' || objAction.type === 'loadEdit') {
            ...
            if (objAction.type === 'loadEdit') {
                ...
                objFinanca.setAjaxActionUser(objSet = {
                    type: objAction.type,
                    url: "<?php echo e(HOME_URI); ?>/providers/ajax-process",
                    id: objAction.id
                });
                objFinanca.ajaxActionUser();
            }
...
</script><?php /**PATH /home/gomes/development/gclinic/App/Views//company/providers/providers.blade.php ENDPATH**/ ?>