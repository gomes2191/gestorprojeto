...
class SystemControl {
    ...
    public function __construct() {
        ...
        if (!$this->controlador) {
            ...
            require_once $this->getFile('RegisterController.php');
   ...
   /**
    ...
    public function get_url_data() {
        ...
        if ((filter_input(INPUT_GET, 'path', FILTER_SANITIZE_URL))) {
            ...
            $this->controlador = GlobalFunctions::chk_array($path, 0);
            $this->controlador .= 'Controller';
            $this->acao = GlobalFunctions::chk_array($path, 1);
            
            // Configura os parâmetros
            if (GlobalFunctions::chk_array($path, 2)) {
