...
class CovenantController extends MainController
{
    ...
    public function index()
    {
        ...
        $modelo = $this->load_model('company/covenant-model');
        ...
        require_once(Config::HOME_URI . '/app/views/company/covenant/covenant-view.php');
    ...
    public function Filters()
    {
        ...
        #   Carrega o view
        require_once(Config::HOME_URI . '/app/views/company/covenant/filters-view.php');
    ...
    public function AjaxProcess()
    {
        ...
        #   Carrega o view
        require_once(Config::HOME_URI . '/app/views/company/covenant/ajax-process-view.php');
