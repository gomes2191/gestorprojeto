...
class StockController extends MainController
{
    ...
    public function index()
    {
        ...
        $modelo = $this->load_model('company/stock-model');
        ...
        require_once(Config::HOME_URI . '/app/views/company/stock/stock-view.php');
    ...
    public function Filters()
    {
        ...
        #   Carrega o view
        require_once(Config::HOME_URI . '/app/views/company/stock/filters-view.php');
    ...
    public function AjaxProcess()
    {
        ...
        #   Carrega o view
        require_once(Config::HOME_URI . '/app/views/company/stock/ajax-process-view.php');
