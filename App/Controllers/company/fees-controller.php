...
class FeesController extends MainController
{
    ...
    public function index()
    {
        ...
        $modelo = $this->load_model('company/fees-model');
        ...
        require_once(Config::HOME_URI . '/app/views/company/fees/fees-view.php');
    ...
    public function Cad()
    {
        ...
        #   Page title
        $this->title = ' Cadastro de honorários';

        #---> Inclua seus models e views aqui

        #   Carrega o modelo
        $modelo = $this->load_model('fees/fees-model');
    ...
    public function Filters()
    {
        ...
        #   Carrega o view
        require_once(Config::HOME_URI . '/app/views/company/fees/filters-view.php');
    ...
    public function AjaxProcess()
    {
        ...
        #   Carrega o view
        require_once(Config::HOME_URI . '/app/views/company/fees/ajax-process-view.php');
