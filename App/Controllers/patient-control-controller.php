...
class PatientControlController extends MainController
{
    ...
    public function index()
    {
        ...
        require_once(Config::HOME_URI . '/views/patient-control/patient-control-view.php');
    ...
    public function Filters()
    {
        ...
        #   Carrega o view
        require_once(Config::HOME_URI . '/views/patient-control/filters-view.php');
    ...
    public function AjaxProcess()
    {
        ...
        #   Carrega o view
        require_once(Config::HOME_URI . '/views/patient-control/ajax-process-view.php');
