 ...
 * @since 0.1
 */
class FinancesPaymentsController extends MainController
{
    ...
    public function index()
    {
        ...
        require_once(Config::HOME_URI . '/views/finances/payments/payments-view.php');
    ...
    public function Filters()
    {
        ...
        #   Carrega o view
        require_once(Config::HOME_URI . '/views/finances/payments/filters-view.php');
    ...
    public function AjaxProcess()
    {
        ...
        #   Carrega o view
        require_once(Config::HOME_URI . '/views/finances/payments/ajax-process-view.php');
