 ...
 * @since 0.1
 */
class FinancesFlowController extends MainController
{
    ...
    public function index()
    {
        ...
        $modelo = $this->load_model('finances/flow-model');
        ...
        require_once(Config::HOME_URI . '/views/finances/flow/flow-view.php');
    ...
    public function BoxView()
    {
        ...
        #   Carrega o view
        require_once(Config::HOME_URI . '/views/finances/flow/box-view.php');
    }   #--> End BoxView
    ...
    public function Filters()
    {
        ...
        #   Carrega o view
        require_once(Config::HOME_URI . '/views/finances/flow/filters-view.php');
    ...
    public function AjaxProcess()
    {
        ...
        #   Carrega o view
        require_once(Config::HOME_URI . '/views/finances/flow/ajax-process-view.php');
