...
//		}
        ...
        require_once (ABSPATH . '/views/finances/flow/flow-view.php');
    ...
    public function BoxView(){
        ...
        #   Carrega o view
        require_once (ABSPATH . '/views/finances/flow/box-view.php');
    ...
    public function Filters() {
       ...
       //echo $search_string;
        ...
        #   Carrega o view
        require_once (ABSPATH . '/views/finances/flow/filters-view.php');
    ...
    public function AjaxProcess() {
        ...
        #   Carrega o view
        require_once (ABSPATH . '/views/finances/flow/ajax-process-view.php');
