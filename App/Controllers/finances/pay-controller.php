...
//		}
        ...
        require_once (ABSPATH . '/app/views/finances/bills_to_pay/pay-view.php');
    ...
    public function Filters() {
       ...
       //echo $search_string;
        ...
        #   Carrega o view
        require_once (ABSPATH . '/app/views/finances/bills_to_pay/filters-view.php');
    ...
    public function AjaxProcess() {
        ...
        #   Carrega o view
        require_once (ABSPATH . '/app/views/finances/bills_to_pay/ajax-process-view.php');
