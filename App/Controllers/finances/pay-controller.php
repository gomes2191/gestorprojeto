...
class PayController extends MainController
{
    ...
    public function index()
    {
        ...
        require_once(Config::HOME_URI . '/app/views/finances/bills_to_pay/pay-view.php');
    ...
    public function Filters()
    {
        ...
        #   Carrega o view
        require_once(Config::HOME_URI . '/app/views/finances/bills_to_pay/filters-view.php');
    ...
    public function AjaxProcess()
    {
        ...
        #   Carrega o view
        require_once(Config::HOME_URI . '/app/views/finances/bills_to_pay/ajax-process-view.php');
