...
class ReceiveController extends MainController
{
    ...
    public function index()
    {
        ...
        * @var $modelo [mixed]*/
        ...
        require_once(Config::HOME_URI . '/app/views/finances/bills_to_receive/receive-view.php');
    ...
    public function Filters()
    {
        ...
        * @var $modelo [mixed]*/
        ...
        #   Carrega o view
        require_once(Config::HOME_URI . '/app/views/finances/bills_to_receive/filters-view.php');
    ...
    public function AjaxProcess()
    {
        ...
        * @var $modelo [mixed]*/
        ...
        #   Carrega o view
        require_once(Config::HOME_URI . '/app/views/finances/bills_to_receive/ajax-process-view.php');
