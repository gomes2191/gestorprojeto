                ...
                <div class="row form-compact">
                    <div class="form-group hide-show col-md-4 col-sm-12 col-xs-12">
                        ...
                        <input type="text" name="user_name" placeholder="Nome completo... " value="<?php
                                                                                                    echo htmlentities(chkArray($modelo->form_data, 'user_name')); ?>" class="form-control" id="user_name" data-validation="custom" data-validation-regexp="^([A-z0-9\s]{3,40})$" data-validation-error-msg="Preencha corretamente o campo." data-validation-help="Digite um nome com (3) ou mais caracteres.">
                        <br>
                    </div>
                ...
                <div class="row form-compact">
                    <div class="form-group hide-show col-md-2 col-sm-4 col-xs-6">
                        ...
                        <select name="esp_1" class="form-control" id="esp_1">
                            <?php $lista = $modelo->get_col_data('esp', 'users_esp', 'esp_id');
                            foreach ($lista as $fetch_userdata) : ?>
                ...
                <div class="row form-compact">
                    <div class="form-group  col-md-4 col-sm-12 col-xs-12">
                        ...
                        <input type="text" name="user_email" placeholder="Seu email será seu usuário de login..." value="<?php
                                                                                                                            echo htmlentities(chkArray($modelo->form_data, 'user_email')); ?>" class="form-control" id="user_email">
                        <p></p>
