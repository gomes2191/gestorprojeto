        ...
        $limit = 5;
        $pagConfig = [
            'totalRows' => COUNT($modelo->searchTable('bills_to_receive')),
            'perPage'   => $limit,
        ...
        #-->
        $receive = $modelo->searchTable('bills_to_receive', ['order_by' => 'receive_id DESC ', 'limit' => $limit]);
        ...
        <div class="row">
            <div class="form-group col-md-12 col-sm-12 col-xs-12">
                <form id="" enctype="multipart/form-data" class="form-register" data-id="" method="post" action="" role="form">
                    <fieldset>
                        <legend>CONTAS A RECEBER <span></span></legend>
                        <div class="row form-compact form-hide" style="display: none;">
                            ...
                            <div class="form-group col-md-2 col-sm-12 col-xs-12">
                                ...
                                <div class="input-group">
                                    <div class="input-group-addon"><i class="fa fa-calendar" aria-hidden="true"></i></div>
                                    <input id="receive_date_pay" name="receive_date_receive" style="border-radius: 0px !important;" type="text" class="form-control data" placeholder="dd/mm/aaaa">
                                    <!--<div class="input-group-addon"><i class="fa fa-money" aria-hidden="true"></i></div>-->
                                </div>
                                <br>
                            </div>
                            ...
                            <div class="form-group col-md-4 col-sm-12 col-xs-12">
                                ...
                                <input id="receive_desc" name="receive_desc" class="form-control" type="text" placeholder="Descreva as informações aqui..." value="">
                                <br>
                            </div>

                            <div class="form-group col-md-2 col-sm-12 col-xs-12">
                                <label for="receive_cat">Categoria:</label>
                                <select id="receive_cat" name="receive_cat" class="form-control">
                            ...
                            <div class="form-group col-md-2 col-sm-12 col-xs-12">
                                <label for="receive_val">Valor montante ( em reais )</label>
                                <div class="input-group">
                                    <div class="input-group-addon">R$</div>
                                    <input id="receive_val" name="receive_val" style="border-radius: 0px !important;" type="text" class="form-control" placeholder="0,00" onkeydown="objFinanca.moneyCash(this,28,event,2,'.',',');">
                                    <div class="input-group-addon"><i class="fa fa-money" aria-hidden="true"></i></div>
                                </div>
                                <br>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <ul class="list-inline list-modal-forn">
                            <li class="list-group-item list-group-item-info list-group-item-text"><b>Vencimento: </b> <span class="receive_venc">---</span></li>
                            <li class="list-group-item list-group-item-warning list-group-item-text"><b>Data de Pagamento: </b> <span class="receive_date_pay">----</span></li>
                            <li class="list-group-item list-group-item-success list-group-item-text"><b>Categoria: </b> <span class="receive_cat">----</span> </li>
                            <li class="list-group-item list-group-item-info list-group-item-text"><b>Descrição: </b> <span class="receive_desc"></span></li>
                            <li class="list-group-item list-group-item-warning list-group-item-text"><b>Valor: </b> <span class="receive_val">----</span></li>
                            <li class="list-group-item list-group-item-success list-group-item-text"><b>Data da inclusao: </b> <span class="receive_created">----</span></li>
                            ...
                            <li class="list-group-item list-group-item-success list-group-item-text"><b>Status: </b> <span class="receive_status">----</span></li>
                        </ul>
                    </div>
                    <div class="modal-footer">
        ...
        <script>
            ...
            objFinanca.setAjaxData('finances-receive/filters');
            objFinanca.ajaxData();
            ...
            function editRegister(id) {
                $.ajax({
                    type: 'POST',
                    dataType: 'JSON',
                    url: '<?= HOME_URI; ?>/finances-receive/ajax-process',
                    data: 'action_type=data&id=' + id,
                    async: true,
                    success: function(result) {
                        console.log(result);
                        document.getElementById('receive_id').value = result.receive_id;
                        document.getElementById('receive_venc').value = result.receive_venc;
                        document.getElementById('receive_date_pay').value = result.receive_date_pay;
                        document.getElementById('receive_desc').value = result.receive_desc;
                        document.getElementById('receive_cat').value = result.receive_cat;
                        document.getElementById('receive_val').value = result.receive_val;
                    }
                });
            }
            ...
            function infoView(id) {
                $.ajax({
                    ...
                    success: function(data) {
                        $('.receive_venc').text((data.receive_venc) ? data.receive_venc : '---');
                        $('.receive_date_pay').text((data.receive_date_pay) ? data.receive_date_pay : '---');
                        $('.receive_cat').text((data.receive_cat) ? data.receive_cat : '---');
                        $('.receive_desc').text((data.receive_desc) ? data.receive_desc : '---');
                        $('.receive_val').text((data.receive_val) ? data.receive_val : '---');
                        $('.receive_created').text((data.receive_created) ? data.receive_created : ' ---');
                        $('.receive_modified').text((data.receive_modified) ? data.receive_modified : '');
                        $('.receive_status').text((data.receive_date_pay) ? 'Pago' : 'Em débito');
                        //$('#editForm').slideDown();
                    }
                });
            }
