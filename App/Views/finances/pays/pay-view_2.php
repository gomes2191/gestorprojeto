                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr class="text-center">
                                                ...
                                                <td><button data-id="<?= $modelo->encodeDecode($pay['pay_id']); ?>" class="btn-dell btn btn-warning btn-xs">Deletar</button></td>
                                        ...
                                        ?>
                                        <tr class="text-center">
                                            <td colspan="10"><span class="label label-primary">Não há registros...</span></td>
                                        </tr>
                                    <?php } ?>
