                    ...
                    <tbody>
                        <?php foreach ($modelo->get_table_data('*', 'stock', 'stock_id') as $fetch_userdata) : ?>
                            <tr class="text-center">
                                ...
                                <td>
                                    <a href="<?= HOME_URI; ?>/stock/cad?pa=<?= $modelo->encodeDecode($fetch_userdata['stock_id']); ?>" class="btn btn-sm btn-default" title="<?= Translate::t('dMsg_10'); ?>">
                                ...
                                <td>
                                    <a href="<?= HOME_URI; ?>/stock/box-view?v=<?= $modelo->encodeDecode($fetch_userdata['stock_id']); ?>" class="btn btn-sm btn-default" data-toggle="modal" data-target="#visualizar-forne" title="Visualizar cadastro">
            ...
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="<?= HOME_URI; ?>/stock?pa=<?= $modelo->encodeDecode($fetch_userdata['stock_id']); ?>" class="btn btn-danger">Eliminar</a>
                    </div>
                </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->
        </div><!-- /.modal -->
