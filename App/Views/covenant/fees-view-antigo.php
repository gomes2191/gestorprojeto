...
$get_decode = intval($modelo->encodeDecode(0, filter_input(INPUT_GET, 'get_two', FILTER_DEFAULT)));
                        ...
                        <?php foreach ($modelo->get_table_data(2, '*',  'covenant_fees', 'covenant_fees_id', $get_decode, 'fees_id') as $fetch_userdata) : ?>
                            <tr class="text-center">
                                ...
                                <td>
                                    ...
                                    <a href="javascript:void(0);" title="Eliminar registro" onclick="delConfirm('<?= $modelo->encodeDecode($fetch_userdata['fees_id']); ?>');" class="btn btn-sm btn-default">
