                    ...
                    <tbody>
                        <?php foreach ($modelo->get_table_data('*', 'laboratory', 'laboratory_id') as $fetch_userdata) : ?>
                            <tr class="text-center">
                                ...
                                <td>
                                    <a href="<?= HOME_URI; ?>/laboratory/cad?get=<?= $modelo->encodeDecode($fetch_userdata['laboratory_id']); ?>" class="btn btn-sm btn-default" title="<?= Translate::t('dMsg_10'); ?>">
                                        <i style="color: #73a839;" class="fa fa-1x fa-pencil-square-o" aria-hidden="true"></i>
                                    </a>
                                </td>
                                <td>
                                    <a href="javascript:void(0);" title="Eliminar registro" onclick="delConfirm('<?= $modelo->encodeDecode($fetch_userdata['laboratory_id']); ?>');" class="btn btn-sm btn-default">
                                        <i style="color: #c71c22;" class="fa fa-1x fa-times" aria-hidden="true"></i>
                                    </a>
                                </td>
                                <td>
                                    <a href="<?= HOME_URI; ?>/laboratory/box-view?v=<?= $modelo->encodeDecode($fetch_userdata['laboratory_id']); ?>" class="btn btn-sm btn-default" data-toggle="modal" data-target="#visualizar-forne" title="Visualizar cadastro">
