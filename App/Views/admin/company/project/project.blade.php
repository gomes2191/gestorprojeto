                ...
                <fieldset>
                    ...
                    <div class="row mb-3 form-hidden" style="display: none">
                        ...
                        <div class="form-group col-md-3 col-sm-12">
                            ...
                            <input id="name" name="name" type="text" class="form-control form-control-sm" placeholder="Nome do Projeto..." value="">
    ...
    <div id="filtros" class="row">
        <div class="form-group mb-3 col-md-4 col-sm-10">
            <div class="input-group">
                <input type="text" class="form-control inputSearch" id="keywords" placeholder="Buscar por: Nome do Projeto..." onkeyup="objGMetodo.ajaxFilter();">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item list-group-item-action list-group-item-primary"><b>Nome do Projeto:</b>&nbsp;<span class="name">---</span></li>
                        ...
                        <li class="list-group-item list-group-item-action list-group-item-info"><b>Progresso?:</b>&nbsp;<span class="progress">---</span></li>
                        <li class="list-group-item list-group-item-action list-group-item-primary"><b>Atrasado?:</b>&nbsp;<span class="late">---</span></li>
                    </ul>
                </div>
    ...
    <script>
        ...
        function typeAction(objAction) {
            ...
            if (objAction.type === 'loadInfo' || objAction.type === 'loadEdit') {
                ...
                if ($('#name').val() == '' || $('#start_date').val() == '' || $('#end_date').val() == '') {
