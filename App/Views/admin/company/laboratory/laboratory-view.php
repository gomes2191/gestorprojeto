        ...
        <div class="row">
            <div class="form-group col-md-12 col-sm-12 col-xs-12">
                <!--Coluna principal do form start-->
                    ...
                    <fieldset>
                        ...
                        <div class="row form-hidden" style="display: none;">
                            ...
                            <div class="form-group col-xs-12 col-sm-12 col-md-12">
                                ...
                                <textarea id="laboratory_obs" class="form-control" name="laboratory_obs" style="margin-top: 0px; width: 100%; max-width: 100%;  margin-bottom: 0px; height: 150px; text-align: justify;" rows="3" placeholder="Outras informações..."><?php echo htmlentities(chkArray($modelo->form_data, 'laboratory_obs')); ?></textarea>
                            </div>
        ...
        <script>
            ...
            objFinanca.setAjaxData(objSet = {
                url: '<?= HOME_URI; ?>/laboratory/filters',
                url_id: '/laboratory/',
                get_decode: false
            });
            objFinanca.ajaxData();
