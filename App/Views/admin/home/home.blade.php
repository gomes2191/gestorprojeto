        ...
        <div class="panel panel-primary">
          ...
          <div class="panel-body">
                <form method="post" action="">
                  ...
                  <?php echo ($modelo->form_msg); ?>
                    ...
                    <!--<div class="form-group">
                        ...
                        echo htmlentities(chkArray($modelo->form_data, 'user_user'));
                        ?>" >
                    </div>-->
                    ...
                    <div class="form-group">
                        ...
                        echo htmlentities(chkArray($modelo->form_data, 'user_password'));
                        ?>" >
                    </div>
                ...
                <!--<div class="form-group">
                        ...
                        echo htmlentities(chkArray($modelo->form_data, 'user_permissions'));
                        ?>" >
                    </div>-->
