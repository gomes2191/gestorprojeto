...
class PayModel extends MainModel
{
    ...
    public function insertRegister()
    {
        ...
        $query_ins = $this->db->insert('bills_to_pay', [
            'pay_cod'           =>  $this->avaliar(chkArray($this->form_data, 'pay_cod')),
            'pay_desc'          =>  $this->avaliar(chkArray($this->form_data, 'pay_desc')),
            'pay_cat'           =>  $this->avaliar(chkArray($this->form_data, 'pay_cat')),
    ...
    public function delRegister($encode_id)
    {
        ...
        $decode_id = $this->encodeDecode(0, $encode_id);
