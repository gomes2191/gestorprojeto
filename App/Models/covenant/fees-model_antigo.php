...
class FeesModel extends MainModel
{
    ...
    public function validate_register_form()
    {
        ...
        if (($db_check_ag->fetchColumn()) >= 1) {
            ...
            $this->updateRegister(chkArray($this->form_data, 'fees_id'));
            return;
        } else {
    ...
    public function insertRegister()
    {
        ...
        $query_ins = $this->db->insert('covenant_fees', [
            'covenant_fees_id'      =>  $this->avaliar(chkArray($this->form_data, 'covenant_fees_id')),
            ...
            'fees_part'             =>  $this->avaliar(chkArray($this->form_data, 'fees_part')),
            'fees_total'            =>  $this->avaliar(chkArray($this->form_data, 'fees_total'))
        ]);
