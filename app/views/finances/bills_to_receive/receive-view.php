            ...
            <div id="inforView" class="modal fade" ><!-- Start Modal inforView -->
                ...
                <script>
                    ...
                    objFinanca.setAjaxData(objSet = {url:'<?= HOME_URI; ?>/receive/filters', url_id: '/receive/', get_decode: false});
                    objFinanca.ajaxData();
                    ...
                    function typeAction( objAction ){     
                        ...
                        if(objAction.type === 'loadInfo' || objAction.type === 'loadEdit'){
                            ...
                            if(objAction.type === 'loadEdit'){
                                objFinanca.setAjaxActionUser(objSet = {type: objAction.type, url:'<?= HOME_URI; ?>/receive/ajax-process', id:objAction.id});
