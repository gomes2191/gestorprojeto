    ...
    **/ 
    public function validate_register_form () {
        ...
        if ( (filter_input(INPUT_SERVER, 'REQUEST_METHOD', FILTER_DEFAULT) === 'POST') && (!empty(filter_input_array(INPUT_POST, FILTER_DEFAULT) ) ) ) {
            ...
            ? $this->form_data['fees_id'] = $this->encode_decode(0, $this->form_data['fees_id']) : '';
        }else {
            # Finaliza a execução.
            return 'err';
        } #--> End
    ...
    **/ 
    public function insertRegister(){
        ...
        $query_ins = $this->db->insert('fees',[
            'covenant_id'     =>  $this->avaliar(chk_array($this->form_data, 'covenant_id')),
            ...
            'fees_val_real'   =>  $this->avaliar(chk_array($this->form_data, 'fees_val_real')),
            'fees_val_final'  =>  $this->avaliar(chk_array($this->form_data, 'fees_val_final')),
            'fees_obs'        =>  $this->avaliar(chk_array($this->form_data, 'fees_obs')),
    ...
    public function updateRegister( $registro_id = NULL ){
        ...
        if ( $registro_id ) {
            ...
            $query_up = $this->db->update('fees', 'fees_id', $registro_id,[
                'fees_id'         =>  $this->avaliar(chk_array($this->form_data, 'fees_id')),
                'fees_cod'        =>  $this->avaliar(chk_array($this->form_data, 'fees_cod')),
                'fees_proc'       =>  $this->avaliar(chk_array($this->form_data, 'fees_proc')),
                'fees_cat'        =>  $this->avaliar(chk_array($this->form_data, 'fees_cat')),
                'fees_desc'       =>  $this->avaliar(chk_array($this->form_data, 'fees_desc')),
