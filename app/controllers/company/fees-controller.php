...
//		}
        ...
        require_once (ABSPATH . '/app/views/company/fees/fees-view.php');
    ...
    public function Filters() {
       ...
       //echo $search_string;
        ...
        #   Carrega o view
        require_once (ABSPATH . '/app/views/company/fees/filters-view.php');
    ...
    public function AjaxProcess() {
        ...
        #   Carrega o view
        require_once (ABSPATH . '/app/views/company/fees/ajax-process-view.php');
