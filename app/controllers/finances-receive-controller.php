 ...
 * @since 0.1
 */
class FinancesReceiveController extends MainController {
...
//		}
        ...
        require_once (ABSPATH . '/views/finances/receive/receive-view.php');
    ...
    public function Filters() {
       ...
       //echo $search_string;
        ...
        #   Carrega o view
        require_once (ABSPATH . '/views/finances/receive/filters-view.php');
    ...
    public function AjaxProcess() {
        ...
        #   Carrega o view
        require_once (ABSPATH . '/views/finances/receive/ajax-process-view.php');
