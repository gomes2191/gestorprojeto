...
(function ($) {
    ...
    Calendar.prototype._update_modal = function () {
        ...
        $('a[data-event-id]', this.context).on('click', function (event) {
            ...
            if (!modal.data('handled.bootstrap-calendar') || (modal.data('handled.bootstrap-calendar') && modal.data('handled.event-id') != event.id)) {
                modal.off('show.bs.modal').off('shown.bs.modal').off('hidden.bs.modal').on('show.bs.modal', function () {
                            ...
                            switch (self.options.modal_type) {
                                ...
                                case "ajax":
                                    $.ajax({
                                        url: url, dataType: "html", async: true, success: function (data) {
    ...
    function showEventsList(event, that, slider, self) {
        ...
        slider.slideUp('fast', function () {
            ...
            slider.html(self.options.templates['events-list']({cal: self, events: self.getEventsBetween(parseInt(event_list.data('cal-start')), parseInt(event_list.data('cal-end')))}));
            row.after(slider);
