...
//		}
        ...
        require_once (ABSPATH . '/views/company/laboratory/laboratory-view.php');
    ...
    public function Filters() {
       ...
       //echo $search_string;
        ...
        #   Carrega o view
        require_once (ABSPATH . '/views/company/laboratory/filters-view.php');
    ...
    public function AjaxProcess() {
        ...
        #   Carrega o view
        require_once (ABSPATH . '/views/company/laboratory/ajax-process-view.php');
