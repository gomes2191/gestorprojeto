            ...
            <fieldset>
                ...
                <div class="row form-compact">
                    ...
                    <div class="form-group col-md-2 col-sm-4 col-xs-12">
                        ...
                        echo htmlentities(chk_array($modelo->form_data, 'laboratory_cpf_cnpj')); ?>">
                        <br>
                    </div>
                    ...
                    <div class="form-group col-md-2 col-sm-12 col-xs-12">
                        ...
                        echo htmlentities(chk_array($modelo->form_data, 'laboratory_rs')); ?>">
                        <br>
                    </div>
                    ...
                    <div class="form-group col-md-2 col-sm-4 col-xs-12">
                        ...
                        echo htmlentities(chk_array($modelo->form_data, 'laboratory_at')); ?>" >
                        <br>
                    </div>
                    ...
                    <div class="form-group col-md-3 col-sm-4 col-xs-12">
                        ...
                        echo htmlentities(chk_array($modelo->form_data, 'laboratory_end')); ?>" >
                        <br>
                    </div>
                    <br>
                </div>
                ...
                <div class="row form-compact">
                    <div class="form-group col-md-2 col-sm-4 col-xs-6">
                        ...
                        echo htmlentities(chk_array($modelo->form_data, 'laboratory_bair')); ?>">
                        <br>
                    </div>
                    ...
                    <div class="form-group col-md-2 col-sm-4 col-xs-6">
                        ...
                        echo htmlentities(chk_array($modelo->form_data, 'laboratory_cid')); ?>">
                        <br>
                    </div>
                    ...
                    <div class="form-group col-md-1 col-sm-4 col-xs-6">
                        ...
                        echo htmlentities(chk_array($modelo->form_data, 'laboratory_uf')); ?>">
                        <br>
                    </div>
                    ...
                    <div class="form-group col-md-3 col-sm-4 col-xs-6">
                        ...
                        echo htmlentities(chk_array($modelo->form_data, 'laboratory_pais')); ?>">
                        <br>
                    </div>
                    ...
                    <div class="form-group col-md-2 col-sm-4 col-xs-6">
                        ...
                        echo htmlentities(chk_array($modelo->form_data, 'laboratory_cep')); ?>">
                    </div>
                    ...
                    <div class="form-group col-md-2 col-sm-4 col-xs-6">
                        ...
                        echo htmlentities(chk_array($modelo->form_data, 'laboratory_cel')); ?>">
                    </div>
                </div>
                <div class="row form-compact">
                    <div class="form-group col-md-2 col-sm-4 col-xs-6">
                        ...
                        echo htmlentities(chk_array($modelo->form_data, 'laboratory_tel_1')); ?>">
                    </div>
                    ...
                    <div class="form-group col-md-2 col-sm-4 col-xs-6">
                        ...
                        echo htmlentities(chk_array($modelo->form_data, 'laboratory_tel_2')); ?>">
                        <br>
                    </div>
                    ...
                    <div class="form-group col-md-2 col-sm-4 col-xs-6">
                        ...
                        echo htmlentities(chk_array($modelo->form_data, 'laboratory_insc_uf')); ?>">
                        <br>
                    </div>
                    ...
                    <div class="form-group col-md-3 col-sm-4 col-xs-6">
                        ...
                        echo htmlentities(chk_array($modelo->form_data, 'laboratory_email')); ?>">
                        <br>
                    </div>
                    ...
                    <div class="form-group col-md-3 col-sm-4 col-xs-6">
                        ...
                        echo htmlentities(chk_array($modelo->form_data, 'laboratory_web_url')); ?>">
                        <br>
                    </div>
                </div>
            </fieldset>
            <fieldset>
                ...
                <div class="row form-compact">
                    <div class="form-group col-md-2 col-sm-2 col-xs-6">
                        ...
                        echo htmlentities(chk_array($modelo->form_data, 'laboratory_rep_nome')); ?>">
                        <br>
                    </div>
                    <div class="form-group col-md-2 col-sm-2 col-xs-6">
                        ...
                        echo htmlentities(chk_array($modelo->form_data, 'laboratory_rep_apelido')); ?>">
                        <br>
                    </div>
                    <div class="form-group col-md-2 col-sm-2 col-xs-6">
                        ...
                        echo htmlentities(chk_array($modelo->form_data, 'laboratory_rep_email')); ?>">
                        <br>
                    </div>
                    <div class="form-group col-md-2 col-sm-2 col-xs-6">
                        ...
                        echo htmlentities(chk_array($modelo->form_data, 'laboratory_rep_cel')); ?>">
                        <br>
                    </div>
                    <div class="form-group col-md-2 col-sm-2 col-xs-6">
                    ...
                    <div class="form-group col-md-2 col-sm-2 col-xs-6">
                        ...
                        echo htmlentities(chk_array($modelo->form_data, 'laboratory_rep_tel_2')); ?>">
                        <br>
                    </div>
                </div>
            </fieldset>
            <fieldset>
                ...
                <div class="row form-compact">
                    <div class="form-group col-md-2 col-sm-2 col-xs-6">
                        ...
                        echo htmlentities(chk_array($modelo->form_data, 'laboratory_banco_1')); ?>">
                        <br>
                    </div>
                    ...
                    <div class="form-group col-md-2 col-sm-2 col-xs-6">
                        ...
                        echo htmlentities(chk_array($modelo->form_data, 'laboratory_agencia_1')); ?>">
                        <br>
                    </div>
                    <div class="form-group col-md-2 col-sm-2 col-xs-6">
                        ...
                        echo htmlentities(chk_array($modelo->form_data, 'laboratory_conta_1')); ?>">
                        <br>
                    </div>
                    <div class="form-group col-md-2 col-sm-2 col-xs-6">
                        ...
                        echo htmlentities(chk_array($modelo->form_data, 'laboratory_titular_1')); ?>">
                        <br>
                    </div>
                </div>
                ...
                <div class="row form-compact">
                    <div class="form-group col-md-2 col-sm-2 col-xs-6">
                        ...
                        echo htmlentities(chk_array($modelo->form_data, 'laboratory_banco_2')); ?>">
                        <br>
                    </div>
                    ...
                    <div class="form-group col-md-2 col-sm-2 col-xs-6">
                        ...
                        echo htmlentities(chk_array($modelo->form_data, 'laboratory_agencia_2')); ?>">
                        <br>
                    </div>
                    <div class="form-group col-md-2 col-sm-2 col-xs-6">
                        ...
                        echo htmlentities(chk_array($modelo->form_data, 'laboratory_conta_2')); ?>">
                        <br>
                    </div>
                    <div class="form-group col-md-2 col-sm-2 col-xs-6">
                        ...
                        echo htmlentities(chk_array($modelo->form_data, 'laboratory_titular_2')); ?>">
                        <br>
                    </div>
                </div>
            </fieldset>
            ...
            <div class="row form-compact">
                <div class="form-group col-xs-12 col-sm-12 col-md-12">
                    ...
                    <textarea id="laboratory_obs" class="form-control" name="laboratory_obs" style="margin-top: 0px; width: 100%; max-width: 100%;  margin-bottom: 0px; height: 150px; text-align: justify;" rows="3" placeholder="Outras informações..." ><?php
                        echo htmlentities(chk_array($modelo->form_data, 'laboratory_obs')); ?></textarea>
                </div>
            </div>
            <div class="row form-compact">
