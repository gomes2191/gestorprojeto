                ...
                <form role="form" method="post" action="">
                  ...
                  <?php echo ($modelo->form_msg); ?>
                    ...
                    <div class="form-group-sm form-group has-feedback has-feedback-left">
                        ...
                        <input type="text" title="Seu nome" name="user_name" class="form-control" id="user_name"
                    ...
                    <div class="form-group-sm form-group has-feedback has-feedback-left">
                        <!--<label for="user_name">Seu nome:</label>-->
                        <input type="text" title="Repita seu email" name="repeat" class="form-control email"
                    ...
                    <div class="form-group-sm form-group has-feedback has-feedback-left">
                        ...
                        <input type="password" title="Sua senha" name="user-password" class="form-control" placeholder="Sua senha..."
                        ...
                        data-validation-error-msg="Digite uma senha válida.">
                        <i class=" form-control-feedback fa fa-key fa-fw"></i>
                    </div>

                    <div class="form-group-sm form-group has-feedback has-feedback-left">
                        <!--<label for="user_password"> Senha: </label>-->
                        <input type="password" title="Repita sua senha" name="repeat" class="form-control"
                        placeholder="Repita sua senha..." data-validation-error-msg="As senhas não são iguais." 
                        data-validation="confirmation" data-validation-confirm="user-password">
                        <i class=" form-control-feedback fa fa-key fa-fw"></i>
